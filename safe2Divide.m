% safe2Divide.m
%
% Looks at a prospective denominator and returns 0 if that denominator
% falls below a given threshold. 1 otherwise.
%
% Author: Jim Strieter
% Date: 09-05-2020
%
...
function y = safe2Divide(someDenominator, smallestAllowableDenominator)
    if nargin < 2
        smallestAllowableDenominator = 1E-9;
    end
    
    y = ~approxEqual(someDenominator, 0, smallestAllowableDenominator);
end
